...
class Data {
    companion object{
        fun getSections(): ArrayList<Section> {
            ...
            family_words.add(Word("Tata","Padre", R.drawable.food))
            family_words.add(Word("Mama","Mamá", R.drawable.food2))
            family_words.add(Word("Brat","Hermano", R.drawable.food))
            family_words.add(Word("Siostra","Hermana", R.drawable.food2))
            family_words.add(Word("Syn","Hijo", R.drawable.food))
            family_words.add(Word("Córka","Hija", R.drawable.food2))
